...
describe('mobile report account selection', () => {
  ...
  it('sums closing balances for the All accounts timeline', () => {
    const timeline = buildCombinedBalanceTimeline({ accounts, categories, transactions, period: '7d', preference });
  ...
  it('assigns distinct event identities to both legs of an All accounts transfer', () => {
    ...
    const timeline = buildCombinedBalanceTimeline({ accounts, categories, transactions: [transfer], period: '7d', preference });
